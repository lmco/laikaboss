...
//Deny is a special outcome that drives disposition of Deny (or Accept), clients use this to block
...
//Alert is arbitary. We could have multiple alert rules, ex. Alert and AlertHigh for signify different alert levels
