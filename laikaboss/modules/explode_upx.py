...
class EXPLODE_UPX(SI_MODULE):
    ...
    def __init__(self,):
        ''' __init__ function merely needs to set its module_name and nothing
        more'''
        ...
        ''' The core of your laika module. This is how your code will be invoked
            ...
            Error Handling:
                1. If upx decompress fails, output file will not be created
                   attempt to open the decompressed file will throw file not
                   exists exception silently passed
            Module Execution:
                ...
                5. If length of the decompressed buffer is > the compressed
                   buffer (decompression worked):
                   True:  Add the buffer to the result object
                   False: Do nothing (future perhaps add failed to decompress
                   metadata?)
                6. Return
        '''
        moduleResult = []
